...
var GridItem = function (_React$Component) {
  ...
  GridItem.prototype.render = function render() {
    ...
    var newChild = _react2.default.cloneElement(child, {
      ...
      className: ['react-grid-item', child.props.className || '', this.props.className, this.props.static ? 'static' : '', this.state.resizing ? 'resizing' : '', isDraggable ? 'react-draggable' : '', this.state.dragging ? 'react-draggable-dragging' : '', useCSSTransforms ? 'cssTransforms' : ''].join(' '),
